...
frame_dirpath     = '/mnt/nas/FAC/FBM/DMF/pnavarr1/default/D2c/cryoCARE/Boston_Paula/FullPipeBin22';                             % PATH of Stack/Metadata/Gain file
gain_path         = '/mnt/nas/FAC/FBM/DMF/pnavarr1/default/D2c/cryoCARE/Boston_Paula/FullPipeBin22'; % PATH to gain file. Optional, if left empty it will take the one in 'frame_dirpath'
...
imod_folder       = 'imodbin22';               % Choose directory name that will be created to output results of Alignframes
...
status = system(['sed -i ''/\"even\": \[/,/],/c\\"even\": ["', output_dirpath, '/even/faimg-even/faimg-even_rec.mrc"],'' ', output_dirpath, '/', imod_folder, '/', stack_name, '/CryoCAREful/train_data_config.json']);
status = system(['sed -i ''/\"odd\": \[/,/],/c\\"odd\": ["', output_dirpath, '/odd/faimg-odd/faimg-odd_rec.mrc"],'' ', output_dirpath, '/', imod_folder, '/', stack_name, '/CryoCAREful/train_data_config.json']);
